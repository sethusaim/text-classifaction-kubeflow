...
SCHEMA_FILE_PATH: str = os.path.join("config", "ecom_schema_prediction.yaml")
...
DATA_INGESTION_BUCKET_NAME: str = "36930ecom-feature-store"
...
DATA_VALIDATION_TRAIN_SCHEMA: str = "config/ecom_schema_training.yaml"

DATA_VALIDATION_REGEX: str = "config/ecom_regex.txt"
...
MODEL_PUSHER_BENTOML_MODEL_NAME: str = "ecom-model"

MODEL_PUSHER_BENTOML_SERVICE_NAME: str = "ecom_model_service"

MODEL_PUSHER_BENTOML_MODEL_IMAGE: str = "ecomimage"
